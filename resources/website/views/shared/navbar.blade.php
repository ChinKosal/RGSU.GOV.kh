                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 24">
                                ...
                                <g fill="none">
                                    <g clip-path="url(#flagpackKh1)">
                                        ...
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M12.764 12.108v-.864c.03-.024.084-.018.12 0v.864zm-2.172 0c-.048-.258-.234-.372-.42-.468v.468z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="m12.764 11.244l-.019-.023l-.011.009v.014zm0 .864h-.03v.03h.03zm.12-.864h.03v-.018l-.017-.009zm0 .864v.03h.03v-.03zm-2.712-.468l.014-.027l-.044-.022v.049zm.42.468v.03h.036l-.007-.036zm-.42 0h-.03v.03h.03zm2.562-.864v.864h.06v-.864zm.163-.027a.186.186 0 0 0-.074-.019a.116.116 0 0 0-.078.023l.038.046a.06.06 0 0 1 .038-.009c.017 0 .035.006.05.013zm.017.891v-.864h-.06v.864zm-.15.03h.12v-.06h-.12zm-2.606-.471c.186.095.36.204.405.447l.058-.012c-.05-.273-.249-.392-.435-.489zm.044.441v-.468h-.06v.468zm.39-.03h-.42v.06h.42z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="m11.756 9.528l-.108.09h-.27l-.108-.096v-.12c.042.012.06.018.09.06a.3.3 0 0 1 .156-.174a.3.3 0 0 1 .15.18c.03-.042.054-.06.09-.06zm.708 2.574c.048-.264.234-.372.42-.462v.462z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M11.648 9.618v.03h.01l.01-.007zm.108-.09l.02.023l.01-.009v-.014zm-.378.09l-.02.022l.008.008h.012zm-.108-.096h-.03v.013l.01.01zm0-.12l.008-.029l-.038-.01v.039zm.09.06l-.024.017l.033.048l.02-.055zm.156-.174l.014-.027l-.013-.006l-.014.006zm.15.18l-.029.009l.018.058l.035-.05zm.09-.06h.03v-.03h-.03zm1.128 2.232h.03v-.048l-.043.021zm-.42.462l-.03-.005l-.006.035h.036zm.42 0v.03h.03v-.03zm-1.217-2.461l.108-.09l-.038-.046l-.108.09zm-.29.007h.27v-.06h-.27zm-.127-.104l.108.096l.04-.044l-.108-.096zm-.01-.142v.12h.06v-.12zm.144.043a.17.17 0 0 0-.049-.05a.221.221 0 0 0-.057-.022l-.016.058a.17.17 0 0 1 .042.015a.112.112 0 0 1 .031.033zm.12-.184a.33.33 0 0 0-.172.191l.056.02a.27.27 0 0 1 .14-.157zm.19.198a.33.33 0 0 0-.164-.198l-.028.054a.27.27 0 0 1 .135.162zm.062-.081a.11.11 0 0 0-.064.02a.212.212 0 0 0-.05.053l.048.034a.154.154 0 0 1 .036-.038a.05.05 0 0 1 .03-.009zm.03.15v-.12h-.06v.12zm1.085 2.085c-.187.09-.386.204-.437.484l.06.01c.045-.248.218-.35.403-.44zm.043.489v-.462h-.06v.462zm-.45.03h.42v-.06h-.42z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="m11.708 9.912l.048-.114v-.15c-.036 0-.06.018-.09.06a.3.3 0 0 0-.15-.18a.3.3 0 0 0-.156.174c-.03-.042-.048-.048-.09-.054v.15l.048.114z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="m11.72 10.308l.156-.198v-.192c-.06 0-.09.03-.132.096c-.042-.138-.12-.162-.228-.228c-.114.06-.192.09-.228.222c-.048-.066-.078-.084-.138-.09v.192l.162.198z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M11.762 10.698s.192-.162.198-.252v-.21c-.072.006-.138.024-.192.114c-.048-.174-.12-.222-.252-.3c-.138.078-.21.126-.252.3c-.06-.09-.12-.108-.198-.12v.216a.9.9 0 0 0 .198.252z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M11.84 11.418s.264-.282.27-.396v-.324c-.096.012-.192.078-.264.216c-.06-.27-.156-.456-.33-.588c-.18.132-.276.318-.336.588c-.072-.138-.162-.204-.258-.216v.324c.018.114.264.396.264.396z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M11.84 11.844s.222-.222.27-.318v-.324c-.096.012-.192.078-.264.21a.84.84 0 0 0-.33-.552c-.18.132-.276.282-.336.552c-.072-.132-.162-.198-.258-.21v.324c.06.096.264.318.264.318z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M11.93 12.096c-.06-.282-.12-.492-.426-.702c-.312.21-.366.42-.432.702z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M12.092 12.252v-.408c-.144.06-.27.138-.318.228c-.048-.228-.15-.324-.276-.462c-.126.138-.21.24-.264.462c-.048-.09-.174-.174-.312-.228v.408zm9.69 1.5v-1.224c.042-.156.18-.3.276-.324v-1.08l-.222.12l-.258 1.134v1.38z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M21.782 13.758v-1.23c.042-.156.18-.3.276-.324v-1.152c-.15 0-.222.192-.222.192l-.258 1.134v1.374z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M21.944 14.07c-.102-.042-.252-.174-.252-.3v-1.536l.072-.12h-2.622l.102.12v1.536a.36.36 0 0 1-.204.3z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M19.574 14.07c.102-.042.252-.174.252-.3v-1.458l-.216-.204h1.776l-.216.204v1.458c0 .126.15.258.252.3z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M19.82 14.07c.102-.042.258-.174.258-.3v-1.32l-.144-.198h1.128l-.144.198v1.32c0 .126.15.258.258.3z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M20.762 12.252h-.534v1.824h.54z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M21.686 10.896h-.258v.192h-.006v1.02h.264v-1.02zm-.186 1.86h-.216v.99h.216zm-1.848 0h-.21v.99h.216zm-.468-1.446h.366v.78h-.366z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M21.428 10.896h-.03l.03-.03zm.258 0v-.03l.03.03zm-.258.192h.03l-.03.03zm-.006 0h-.03l.03-.03zm0 1.02v.03l-.03-.03zm.264 0h.03l-.03.03zm-.402.648h-.03l.03-.03zm.216 0v-.03l.03.03zm-.216.99v.03l-.03-.03zm.216 0h.03l-.03.03zm-2.058-.99h-.03l.03-.03zm.21 0v-.03l.03.03zm-.21.99v.03l-.03-.03zm.216 0h.03l-.03.03zm-.108-2.436v-.03l.03.03zm-.366 0h-.03l.03-.03zm.366.78h.03l-.03.03zm-.366 0v.03l-.03-.03zm2.244-1.224h.258v.06h-.258zm-.03.222v-.192h.06v.192zm.024-.03h.006v.06h-.006zm-.03 1.05v-1.02h.06v1.02zm.294.03h-.264v-.06h.264zm.03-1.05v1.02h-.06v-1.02zm0-.192v.192h-.06v-.192zm-.432 1.83h.216v.06h-.216zm-.03 1.02v-.99h.06v.99zm.246.03h-.216v-.06h.216zm.03-1.02v.99h-.06v-.99zm-2.088-.03h.21v.06h-.21zm-.03 1.02v-.99h.06v.99zm.246.03h-.216v-.06h.216zm.024-1.02l.006.99h-.06l-.006-.99zm-.132-1.416h-.366v-.06h.366zm-.03.75v-.78h.06v.78zm-.336-.03h.366v.06h-.366zm.03-.75v.78h-.06v-.78z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                        ...
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M19.238 12.108v-.864c-.03-.024-.084-.018-.12 0v.864zm2.172 0c.048-.258.234-.372.42-.468v.468z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="m19.238 11.244l.019-.023l.011.009v.014zm0 .864h.03v.03h-.03zm-.12-.864h-.03v-.018l.017-.009zm0 .864v.03h-.03v-.03zm2.712-.468l-.014-.027l.044-.022v.049zm-.42.468v.03h-.036l.007-.036zm.42 0h.03v.03h-.03zm-2.562-.864v.864h-.06v-.864zm-.163-.027a.186.186 0 0 1 .074-.019a.12.12 0 0 1 .078.023l-.038.046a.06.06 0 0 0-.038-.009a.126.126 0 0 0-.05.013zm-.017.891v-.864h.06v.864zm.15.03h-.12v-.06h.12zm2.606-.471c-.186.095-.36.204-.405.447l-.058-.012c.05-.273.249-.392.435-.489zm-.044.441v-.468h.06v.468zm-.39-.03h.42v.06h-.42z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="m20.246 9.528l.108.09h.27l.108-.096v-.12c-.042.012-.06.018-.09.06a.3.3 0 0 0-.156-.174a.3.3 0 0 0-.15.18c-.03-.042-.054-.06-.09-.06zm-.708 2.574c-.048-.264-.234-.372-.42-.462v.462z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M20.354 9.618v.03h-.01l-.01-.007zm-.108-.09l-.02.023l-.01-.009v-.014zm.378.09l.02.022l-.009.008h-.011zm.108-.096h.03v.013l-.01.01zm0-.12l-.008-.029l.038-.01v.039zm-.09.06l.024.017l-.034.048l-.018-.055zm-.156-.174l-.014-.027l.013-.006l.014.006zm-.15.18l.029.009l-.018.058l-.036-.05zm-.09-.06h-.03v-.03h.03zm-1.128 2.232h-.03v-.048l.043.021zm.42.462l.03-.005l.006.035h-.036zm-.42 0v.03h-.03v-.03zm1.217-2.461l-.108-.09l.038-.046l.108.09zm.289.007h-.27v-.06h.27zm.128-.104l-.108.096l-.04-.044l.108-.096zm.01-.142v.12h-.06v-.12zm-.145.043a.17.17 0 0 1 .05-.05a.241.241 0 0 1 .057-.022l.016.058a.168.168 0 0 0-.042.015a.112.112 0 0 0-.032.033zM20.5 9.26a.33.33 0 0 1 .171.191l-.056.02a.27.27 0 0 0-.14-.157zm-.192.198a.33.33 0 0 1 .165-.198l.028.054a.27.27 0 0 0-.135.162zm-.061-.081a.11.11 0 0 1 .064.02a.21.21 0 0 1 .05.053l-.049.034a.152.152 0 0 0-.035-.038a.05.05 0 0 0-.03-.009zm-.03.15v-.12h.06v.12zm-1.085 2.085c.187.09.386.204.436.484l-.059.01c-.045-.248-.218-.35-.403-.44zm-.043.489v-.462h.06v.462zm.45.03h-.42v-.06h.42z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="m20.294 9.912l-.048-.114v-.15c.036 0 .06.018.09.06a.3.3 0 0 1 .15-.18a.3.3 0 0 1 .156.174c.03-.042.048-.048.09-.054v.15l-.048.114z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="m20.282 10.308l-.156-.198v-.192c.06 0 .09.03.132.096c.042-.138.12-.162.228-.228c.114.06.192.09.228.222c.048-.066.078-.084.138-.09v.192l-.162.198z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M20.24 10.698s-.192-.162-.198-.252v-.21c.072.006.138.024.192.114c.048-.174.12-.222.252-.3c.138.078.21.126.252.3c.06-.09.12-.108.198-.12v.216a.899.899 0 0 1-.198.252z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M20.162 11.418s-.264-.282-.27-.396v-.324c.096.012.192.078.264.216c.06-.27.156-.456.33-.588c.18.132.276.318.336.588c.072-.138.162-.204.258-.216v.324c-.018.114-.264.396-.264.396z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M20.162 11.844s-.222-.222-.27-.318v-.324c.096.012.192.078.264.21a.84.84 0 0 1 .33-.552c.18.132.276.282.336.552c.072-.132.162-.198.258-.21v.324c-.06.096-.264.318-.264.318z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M20.072 12.096c.06-.282.12-.492.426-.702c.312.21.366.42.432.702z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M19.91 12.252v-.408c.144.06.27.138.318.228c.048-.228.15-.324.276-.462c.126.138.21.24.264.462c.048-.09.174-.174.312-.228v.408z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M22.58 14.43H9.416v.486H22.58zM8.642 15.558H23.36v.75h.39v.75H8.252v-.75h.39z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M9.416 14.43v-.03h-.03v.03zm13.164 0h.03v-.03h-.03zm-13.164.486h-.03v.03h.03zm13.164 0v.03h.03v-.03zm.78.642h.03v-.03h-.03zm-14.718 0v-.03h-.03v.03zm14.718.75h-.03v.03h.03zm.39 0h.03v-.03h-.03zm0 .75v.03h.03v-.03zm-15.498 0h-.03v.03h.03zm0-.75v-.03h-.03v.03zm.39 0v.03h.03v-.03zm.774-1.848H22.58v-.06H9.416zm.03.456v-.486h-.06v.486zm13.134-.03H9.416v.06H22.58zm-.03-.456v.486h.06v-.486zm.81 1.098H8.642v.06H23.36zm.03.78v-.75h-.06v.75zm.36-.03h-.39v.06h.39zm.03.78v-.75h-.06v.75zm-15.528.03H23.75v-.06H8.252zm-.03-.78v.75h.06v-.75zm.42-.03h-.39v.06h.39zm-.03-.72v.75h.06v-.75z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M22.364 14.058H9.644v.372h12.72zm.612.858H9.032v.636h13.944z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M9.644 14.058v-.03h-.03v.03zm12.72 0h.03v-.03h-.03zm-12.72.372h-.03v.03h.03zm12.72 0v.03h.03v-.03zm-13.332.486v-.03h-.03v.03zm13.944 0h.03v-.03h-.03zm-13.944.636h-.03v.03h.03zm13.944 0v.03h.03v-.03zM9.644 14.088h12.72v-.06H9.644zm.03.342v-.372h-.06v.372zm12.69-.03H9.644v.06h12.72zm-.03-.342v.372h.06v-.372zm-13.302.888h13.944v-.06H9.032zm.03.606v-.636h-.06v.636zm13.914-.03H9.032v.06h13.944zm-.03-.606v.636h.06v-.636z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M11.024 14.058h.96v3h-.96z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M11.774 14.058h-.534l-.006 3h.54zm4.686 0h-.96v3h.96z"
                                            clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M11.24 14.058v-.03h-.03v.03zm.534 0h.03v-.03h-.03zm-.54 3h-.03v.03h.03zm.54 0v.03h.03v-.03zm3.726-3v-.03h-.03v.03zm.96 0h.03v-.03h-.03zm-.96 3h-.03v.03h.03zm.96 0v.03h.03v-.03zm-5.22-2.97h.534v-.06h-.534zm.024 2.97l.006-3h-.06l-.006 3zm.51-.03h-.54v.06h.54zm-.03-2.97v3h.06v-3zm3.756.03h.96v-.06h-.96zm.03 2.97v-3h-.06v3zm.93-.03h-.96v.06h.96zm-.03-2.97v3h.06v-3z" />
                                        <path fill="#fff" fill-rule="evenodd"
                                            d="M16.262 14.058h-.54v3h.54zm4.71 0h-.96v3h.96z" clip-rule="evenodd" />
                                        <path fill="#000"
                                            d="M15.722 14.058v-.03h-.03v.03zm.54 0h.03v-.03h-.03zm-.54 3h-.03v.03h.03zm.54 0v.03h.03v-.03zm3.75-3v-.03h-.03v.03zm.96 0h.03v-.03h-.03zm-.96 3h-.03v.03h.03zm.96 0v.03h.03v-.03zm-5.25-2.97h.54v-.06h-.54zm.03 2.97v-3h-.06v3zm.51-.03h-.54v.06h.54zm-.03-2.97v3h.06v-3zm3.78.03h.96v-.06h-.96zm.03 2.97v-3h-.06v3zm.93-.03h-.96v.06h.96zm-.03-2.97v3h.06v-3z" />
                                        <path fill="#fff" stroke="#000" stroke-width=".06"
                                            d="M20.222 14.058h.54v3h-.54z" />
                                        <path fill="#000"
                                            d="M10.22 13.802H21.8v-.06H10.22zm1.008 2.928h.552v-.06h-.552zm0-.378h.552v-.06h-.552zm0-.372h.552v-.06h-.552zm0-.378h.552v-.06h-.552zm0-.372h.552v-.06h-.552zm0-.378h.552v-.06h-.552zm0-.372h.552v-.06h-.552zm4.5 2.25h.516v-.06h-.516zm0-.378h.516v-.06h-.516zm0-.372h.516v-.06h-.516zm0-.378h.516v-.06h-.516zm0-.372h.516v-.06h-.516zm0-.378h.516v-.06h-.516zm0-.372h.516v-.06h-.516zm4.488 2.25h.552v-.06h-.552zm0-.378h.552v-.06h-.552zm0-.372h.552v-.06h-.552zm0-.378h.552v-.06h-.552zm0-.372h.552v-.06h-.552zm0-.378h.552v-.06h-.552zm0-.372h.552v-.06h-.552z" />
                                    </g>
                                    <defs>
                                        <clipPath id="flagpackKh1">
                                            <use href="#flagpackKh0" />
                                        </clipPath>
                                    </defs>
                                </g>
                            </svg>
                            <span class="font-Poppins text-sm">Khmer</span>
                        </div>
                        <div
                            class="english w-[50%] h-full flex items-center gap-1 bg-white pr-1 pl-1 hover:cursor-pointer rounded-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 32 24">
                                <defs>
                                    <path id="flagpackGbNir0" fill="#fff" d="M0 0h32v24H0z" />
                                </defs>
                                <g fill="none">
                                    <g clip-path="url(#flagpackGbNir3)">
                                        <use href="#flagpackGbNir0" />
                                        <path fill="#2E42A5" fill-rule="evenodd" d="M0 0v24h32V0z"
                                            clip-rule="evenodd" />
                                        <mask id="flagpackGbNir1" width="32" height="24" x="0" y="0"
                                            maskUnits="userSpaceOnUse" style="mask-type:luminance">
                                            <path fill="#fff" fill-rule="evenodd" d="M0 0v24h32V0z"
                                                clip-rule="evenodd" />
                                        </mask>
                            ...
                            <span class="font-Poppins text-sm">English</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-menu w-[60%] h-full  m-auto overflow-hidden">
            <ul>
                <a class="{{ request()->routeIs('coverpage') ? 'active-menu' : '' }}" href="{{ route('coverpage') }}">
                    <li class="font-Hanuman text-base">
                        Sokkesperson
                    </li>
                </a>
                <a href="#">
                ...
                <a class="{{ request()->routeIs('page6') ? 'active-menu' : '' }}" href="{{ route('page6') }}">
                    <li class="font-Hanuman text-base">
                        PM
                    </li>
                </a>
