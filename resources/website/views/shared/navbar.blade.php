        ...
        <div class="top-header w-full h-full">
            <div class="container-sec w-full">
                <div class="info-menu  m-auto h-full ">
                    ...
                    <div class="info-right w-full h-full ">
                        <ul class="flex  justify-end items-center">
                            <li>
                                <a href="#">Achieve</a>
                            </li>
                            <li class="switch-lange  relative">
                                <div class="current-lange flex items-center gap-2">
                                    <svg class="hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="20"
                                        height="20" viewBox="0 0 32 24">
                                        <defs>
                                    ...
                                    <a href="#">English</a>
                                    <svg class="text-white hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <ul
                                    class="sub-language hidden w-[140px] h-auto bg-white drop-shadow-md absolute top-[112%] right-0">
                                    <li
                                        class="flex items-center gap-2 transition duration-300 ease-in-out hover:bg-yellow-400 hover:cursor-pointer">
                                            ...
                                            <g fill="none">
                                                <g clip-path="url(#flagpackKh1)">
                                                    ...
                                                    <path fill="#fff" stroke="#000" stroke-linejoin="bevel"
                                                        stroke-width=".06" d="M12.62 11.31h6.828v2.628H12.62z" />
                                                    ...
                                                    <path fill="#fff" stroke="#000" stroke-linejoin="bevel"
                                                        stroke-width=".06" d="M12.62 11.442h6.828v.258H12.62z" />
                                                    <path fill="#fff" fill-rule="evenodd"
                                                    ...
                                                    <path fill="#fff" fill-rule="evenodd"
                                                        d="M16.262 14.058h-.54v3h.54zm4.71 0h-.96v3h.96z"
                                                        clip-rule="evenodd" />
                                                    <path fill="#000"
                    ...
                    <div class="w-full h-full flex flex-row">
                        <div class="logo-box w-[35%] h-full">
                            <div class="image-logo w-full h-full">
                                <img class="w-full h-full object-contain" src="./images/logo/rgsu_logo.png"
                                    alt="">
                            </div>
                        </div>
                        <div class="search-box w-[65%] h-full">
                            <div class="w-full h-full flex items-center justify-end">
                                <div class="w-[90%] h-[45px] flex bg-search_background"
                                    style="border: 1px solid #1c7297">
                                    <div class="dropdown-activi w-[30%] h-full flex items-center justify-center relative"
                                        style="border-right: 1px solid #1c7297">
                                        <div class="flex items-center gap-2">
                                            <p class="text-white text-sm">WORK ACTIVITIES </p>
                                            <i class="fa-solid fa-chevron-down text-xs text-white"></i>
                                        </div>
                                        <ul
                                            class="item-drop  absolute w-full h-auto top-[102%]  bg-white drop-shadow-md">
                                            <li>
                                                <a href="#">2019</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="search w-[70%] h-full ">
                                        <form action="#" class="w-full h-full flex">
                                            <input
                                                class="w-[89%] h-full text-sm outline-none border-transparent text-white bg-inherit py-2 px-3"
                                                type="text" value="I am Looking for..."
                                                onfocus="if (this.value==this.defaultValue) this.value = ''"
                                                onblur="if (this.value=='') this.value = this.defaultValue" />
                                            <button type="submit" value=""
                                                class="w-[11%] h-full border-transparent bg-search_border hover:cursor-pointer">
            ...
            <div class="container">
                <nav class="main-nav">
                    <ul>
                        ...
                        <li>
                            <a href="#">Press Briefing </a>

                        </li>
                        <li>
                            <a href="#">Public Schedule</a>
