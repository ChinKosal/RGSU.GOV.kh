        ...
        <div class="content-body">
            <div class="content-tab">
                ...
                <div class="content-action-button">
                    ...
                    @can('principal-recipient-create')
                        <template x-if="Ids.length <= 0">
            ...
            @include('admin::pages.principal.table')
        </div>
        <div x-show="type == isTypePudr">
            @include('admin::pages.principal.store')
        </div>
        <div x-show="type != isTypePudr">
            @include('admin::pages.principal.page')
        </div>
    </div>
@stop
@section('script')
            ...
            onUpdateOption(data, option){
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: `{{ route('admin-principal-recipient-saveSingleOption') }}`,
                                method: 'POST',
                                data: {
                                    id: data.id,
                                    option: option
            ...
            bulkHideShow(option) {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: "{{ route('admin-principal-recipient-bulk-hide-show') }}",
                                method: 'DELETE',
            ...
            onDelete(data) {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: `{{ route('admin-principal-recipient-delete') }}`,
                                method: 'DELETE',
                                data: {
                                    id: data.id
                                }
            ...
            onRestore(data) {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: `{{ route('admin-principal-recipient-restore') }}`,
                                method: 'PUT',
                                data: {
                                    id: data.id
                                }
            ...
            onDestroy(data) {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: `{{ route('admin-principal-recipient-destroy') }}`,
                                method: 'DELETE',
                                data: {
                                    id: data.id
                                }
