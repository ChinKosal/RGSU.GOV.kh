<div class="table">
                    ...
                    <div class="column" x-data="{ status: item.status }">
                        ...
                        <div class="row table-row-15">
                            <div class="image thumbnail" data-fancybox
                                :data-src="item.thumbnail || '{{ asset('images/logo/no.jpg') }}'">
                                <img x-bind:src="item.thumbnail || '{{ asset('images/logo/no.jpg') }}'"
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => __('form.title.video')]),
            'msg' => __('table.empty.message', ['name' => __('form.title.video')]),
        ])
        @endcomponent
    </template>
</div>
