        ...
        <form class="form-wrapper scroll-form">
            ...
            <div class="form-body">
                ...
                <div class="row-2">
                    ...
                    <div class="form-row">
                        <label>@lang('form.body.label.year')</label>
                        <input type="text" x-mask.numeral x-model="form.year" :disabled="form.disabled"
                            placeholder="@lang('form.body.placeholder.year')" maxlength="4" />
                        <span class="error" x-show="validate?.year" x-text="validate?.year"></span>
                    </div>
                </div>
                <div class="row-2">
                    <div class="form-row">
