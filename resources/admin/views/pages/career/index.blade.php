        ...
        <div class="content-body">
            <div class="content-tab">
                <div class="content-tab-wrapper">
                    <span class="title">
                        @lang('form.total', ['name' => __('form.title.career')]) <span x-text="table?.paginate?.totalItems"></span>
                    </span>
                </div>
            ...
            @include('admin::pages.career.table')
        </div>
        @include('admin::pages.career.store')
    </div>
@stop
@section('script')
    ...
    <script type="module">
        Alpine.data('page', () => ({
            table: new Table("{{ route('admin-career-data') }}"),
            Ids: [],
            status: false,
            ...
            onUpdateOption(data, option){
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: `{{ route('admin-career-saveSingleOption') }}`,
                                method: 'POST',
                                data: {
                                    id: data.id,
                                    option: option
            ...
            bulkHideShow(option) {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: "{{ route('admin-career-bulk-hide-show') }}",
                                method: 'DELETE',
            ...
            onRestore(data) {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            Axios({
                                url: `{{ route('admin-career-restore') }}`,
                                method: 'PUT',
                                data: {
                                    id: data.id
                                }
