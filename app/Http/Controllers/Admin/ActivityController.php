...
class ActivityController extends Controller
{
    ...
    {
        $this->middleware('permission:activity-view', ['only' => ['index', 'data']]);
        $this->middleware('permission:activity-create', ['only' => ['onStore']]);
        $this->middleware('permission:activity-update', ['only' => ['bulkHideShow', 'saveSingleOption']]);
        $this->middleware('permission:activity-delete', ['only' => ['onRestore','onDelete','onDestroy']]);
    ...
    public function onStore(ActivityRequest $request)
    {
        $items = [
            'title'         => json_encode([
                'en' => $request->title_en,
